...
from studio.training.keras.data_generators import EnhancedDirectoryIterator, EnhancedImageDataGenerator, \
...
def test_enhanced_image_data_generator_random_crop(train_catdog_dataset_path, train_catdog_dataset_json_path):
    ...
    for datagen in datagens:
        ...
        img = Image.open('tests/training/keras/files/catdog/val/cat/cat-4.jpg')
