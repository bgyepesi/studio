...
The models supported are the ones specified in the [keras-model-specs](https://github.com/aip-labs/keras-model-specs) package 
...
And the default model configurations are specified [here](https://github.com/aip-labs/keras-model-specs/blob/master/keras_model_specs/model_specs.json).
...
You will find a guide of use [here](https://github.com/aip-labs/keras-trainer/blob/master/example.ipynb)
